...
namespace BoletoNetCore.Testes
{
    public class BancoItauCarteira112Tests
    {
        ...
        {
            Utils.TestarHomologacao(_banco, TipoArquivo.CNAB400, nameof(BancoItauCarteira112Tests), 5, false, "N", 223344);
        }
        ...
        public void Itau_112_BoletoOK(decimal valorTitulo, string nossoNumero, string numeroDocumento, string digitoVerificador, string nossoNumeroFormatado, string codigoDeBarras, string linhaDigitavel, params int[] anoMesDia)
        {
            //Ambiente
